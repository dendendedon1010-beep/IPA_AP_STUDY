...
export const ipaPastExamCatalog: IpaPastExamCatalogItem[] = [
  ...
  },
  {
    ...
    note: '公式確認済みの29問を取り込み済み。テキスト問題と表付き問題を含む。図表画像が必要な問題は未取り込み',
    isReadyForImport: true,
    importedQuestionCount: 29,
    importStatus: 'partial',
  },
  {
  ...
  },
  {
    ...
    note: '公式確認済みの30問を取り込み済み。うち2問は表付き問題。図表画像が必要な問題は未取り込み',
    isReadyForImport: true,
  ...
  },
  {
    ...
    sourcePageUrl: 'https://www.ipa.go.jp/shiken/mondai-kaiotu/2023r05.html',
    note: '公式確認済みの30問を取り込み済み。テキスト問題を中心に取り込み済み。図表画像が必要な問題は未取り込み',
    isReadyForImport: true,
    importedQuestionCount: 30,
    importStatus: 'partial',
  },
  ...
  },
  {
    ...
    note: '公式確認済みの32問を取り込み済み。うち6問は表付き問題。図表画像が必要な問題などは未取り込み',
    isReadyForImport: true,
